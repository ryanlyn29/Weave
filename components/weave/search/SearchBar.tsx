    ...
    <div className="max-w-3xl mx-auto">
      <form onSubmit={handleSubmit} className="relative">
        <input
          ...
          className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <button
          type="submit"
        ...
        <div className="flex flex-wrap gap-2">
          {examplePrompts.map((prompt, idx) => (
            <button
              ...
              className="text-xs px-3 py-1.5 bg-gray-100 text-gray-700 rounded-2xl hover:bg-gray-200 transition-colors"
            >
              {prompt}
            </button>
          ))}

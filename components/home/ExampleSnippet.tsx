      ...
      <div className="max-w-4xl mx-auto">
        <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              <div className="flex gap-2">
                ...
                <div className="flex-1">
                  ...
                  <div 
                    className={`text-sm rounded-xl px-3 py-2 bg-gray-50 border border-gray-200 ${
                      highlighted === 'date' ? 'ring-2 ring-blue-500 border-blue-500' : ''
                    }`}
                    onMouseEnter={() => setHighlighted('date')}
                    onMouseLeave={() => setHighlighted(null)}
                  >
                    Want to meet <span className="font-medium text-blue-600">this Saturday at 2pm</span> for coffee?
                  </div>
                </div>
              </div>
              <div className="flex gap-2">
                ...
                <div className="flex-1">
                  ...
                  <div 
                    className={`text-sm rounded-xl px-3 py-2 bg-gray-50 border border-gray-200 ${
                      highlighted === 'promise' ? 'ring-2 ring-blue-500 border-blue-500' : ''
                    }`}
                    onMouseEnter={() => setHighlighted('promise')}
                    onMouseLeave={() => setHighlighted(null)}
                  >
                    Sounds good! <span className="font-medium text-blue-600">I'll bring the notes</span> we discussed.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-blue-50 rounded-xl border border-blue-200 p-4">
            <div className="text-xs text-blue-700 mb-3 font-medium">WEAVE saved this</div>
            <div className="space-y-3">

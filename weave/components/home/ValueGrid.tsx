  ...
  const values = [
    {
      ...
      preview: (
        <div className="bg-white rounded-bubble p-3 border border-gray-200 mt-3">
    ...
    },
    {
      ...
      preview: (
        <div className="bg-white rounded-bubble p-3 border border-gray-200 mt-3">
          ...
          <div className="text-xs text-primary-600 mt-1">Status: Pending</div>
        </div>
      ),
    },
    {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {values.map((value, idx) => (
            <div key={idx} className="bg-gray-50 rounded-bubble-lg p-6 border border-gray-200">
